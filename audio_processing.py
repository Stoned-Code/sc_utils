...
import gc
from image_processing import is_solid_color
import hashlib
...
def process_mel(mel, scale, pad_to_square = True):
    if type(mel) == str:
        mel = Image.open(mel)
...
if __name__ == "__main__":
    import argparse
    import pathlib
    from image_processing import process_image, closeness_to_black, closeness_to_white, get_hash
    import pandas as pd
